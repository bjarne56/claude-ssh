...
bitflags! {
    ...
    pub(crate) struct LineBits : u16 {
        ...
        /// true if we have scanned this line against keyword highlight rules.
        /// Mirror of SCANNED_IMPLICIT_HYPERLINKS for keyword highlighting.
        const SCANNED_KEYWORD_HIGHLIGHT = 1<<9;
        /// true if the last keyword highlight scan produced any matches
        /// that wrote new color attributes onto cells in this line.
        const HAS_KEYWORD_HIGHLIGHT = 1<<10;
    }
}
