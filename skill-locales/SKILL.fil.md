---
name: sshops
description: Mga remote SSH operations. Awtomatikong nire-resolve ang mga host mula sa SecureCRT; isang IP/keyword/path ang kumokonekta. Live view + recording + command index.
---
