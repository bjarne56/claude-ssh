---
name: sshops
description: Απομακρυσμένες λειτουργίες SSH. Αυτόματη ανάλυση hosts από SecureCRT; ένα IP/λέξη-κλειδί/διαδρομή συνδέει. Ζωντανή προβολή + εγγραφή + ευρετήριο εντολών.
---
