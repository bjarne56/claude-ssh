---
name: sshops
description: Operațiuni SSH la distanță. Rezolvă automat hosturi din SecureCRT; un IP/cuvânt cheie/cale conectează. Vedere live + înregistrare + index comenzi.
---
