---
name: sshops
description: Opérations SSH à distance. Hôtes auto-résolus depuis SecureCRT ; une IP/mot-clé/chemin pour se connecter. Vue live + enregistrement + index de commandes.
---
